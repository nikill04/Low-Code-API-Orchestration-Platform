...
function SparkIcon() { return <svg {...iconProps()}><path d="M12 3v4M12 17v4M3 12h4M17 12h4M6 6l2.5 2.5M15.5 15.5 18 18M18 6l-2.5 2.5M8.5 15.5 6 18"/></svg>; }
function KeyIcon() { return <svg {...iconProps()}><circle cx="8" cy="15" r="4"/><path d="M11 12 20 3M16 8l3 3M13 11l2.5 2.5"/></svg>; }
function SunIcon() { return <svg {...iconProps()}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M2 12h2M20 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4"/></svg>; }
function MoonIcon() { return <svg {...iconProps()}><path d="M20 14.5A8 8 0 1 1 9.5 4a6.5 6.5 0 0 0 10.5 10.5Z"/></svg>; }